...
****************************************************************************************/
	...
	//마스터DB1(쓰기용) 생성
	$userMaster01 = new DBMaster("cbt_user001",$server1);
	...
	$userSlave01 = new DBSlave("cbt_user001",$server1);
	...
	//마스터DB2(쓰기용) 생성
	$userMaster02 = new DBMaster("cbt_user002",$server1);
	...
	$userSlave02 = new DBSlave("cbt_user002",$server1);
	...
	//마스터1(쓰기용) 생성
	$logMaster01 = new DBMaster("cbt_log001",$server1);
	...
	$logSlave01 = new DBSlave("cbt_log001",$server1);
