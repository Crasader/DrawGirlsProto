...
<table class="LQDataTable" dbSource="dataManager2.php"  dbClass="EndlessPlayList" autoLoad="false" autoSetting="true" dbWhere='{}' dbLimit="10" dbSort='{"no":"desc"}' name="datatable" border=1>
	<thead>
	</thead>
	<tbody datazone>
