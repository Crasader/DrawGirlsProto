...
<h2 id="tables-contextual-classes">|아이템변경정보</h2>
<table class="LQDataTable" dbSource="dataManager2.php"  dbClass="UserPropertyHistory" autoLoad="false" autoSetting="true" dbWhere='{}' dbLimit="10" dbSort='{"no":"desc"}' name="datatable" border=1 commenterx='{"type":"custom","func":"commenter"}'>
	<thead>
	</thead>
	<tbody datazone>
