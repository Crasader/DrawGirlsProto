...
<table class="LQDataTable" dbSource="dataManager2.php"  dbClass="GiftBoxHistory" autoLoad="false" dbWhere='{}' dbLimit="10" dbSort='{"no":"desc"}' name="datatable" border=1 commenter='{"type":"custom","func":"commenter"}'>
	<thead>
		<tr>
