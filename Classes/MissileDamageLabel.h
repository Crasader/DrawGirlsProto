...
//  DGproto
//
//  Created by 사원3 on 13. 11. 9..
//
//

#ifndef __DGproto__MissileDamageLabel__
#define __DGproto__MissileDamageLabel__
...
#endif /* defined(__DGproto__MissileDamageLabel__) */
