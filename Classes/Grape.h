...
class Grape : public KSCumberBase
{
public:
	Grape() : RADIUS(15.f),// mEmotion(nullptr),
...
//		if(mEmotion)
//			mEmotion->selfRemove();
//		mEmotion = Emotion::create(t_type, this, callfunc_selector(Grape::nullmEmotion));
...
//	virtual void startAnimationDirection(){}
	...
	virtual void startTeleport()
	{
		...
		CCCallFunc* t_call = CCCallFunc::create(this, callfunc_selector(Grape::smaller));
	...
	virtual void smaller()
	{
		...
		CCCallFunc* t_call = CCCallFunc::create(this, callfunc_selector(Grape::randomPosition));
