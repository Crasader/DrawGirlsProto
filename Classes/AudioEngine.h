...
//			mySAE->preloadEffect("groan29.mp3");
			...
			mySAE->preloadEffect("groan1.wav");
			mySAE->preloadEffect("groan2.wav");
			mySAE->preloadEffect("groan3.wav");
			mySAE->preloadEffect("groan4.wav");
			mySAE->preloadEffect("groan5.wav");
			mySAE->preloadEffect("groan6.wav");
			mySAE->preloadEffect("groan7.wav");
			mySAE->preloadEffect("groan8.wav");
			mySAE->preloadEffect("groan9.wav");
			mySAE->preloadEffect("groan10.wav");
			mySAE->preloadEffect("groan11.wav");
