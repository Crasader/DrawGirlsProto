...
class Banana : public KSCumberBase
{
public:
	Banana() : RADIUS(15.f),// mEmotion(nullptr),
...
//		if(mEmotion)
//			mEmotion->selfRemove();
//		mEmotion = Emotion::create(t_type, this, callfunc_selector(Banana::nullmEmotion));
...
//	}
	...
	virtual void startTeleport()
	{
		...
		CCCallFunc* t_call = CCCallFunc::create(this, callfunc_selector(Banana::smaller));
	...
	virtual void smaller()
	{
		...
		CCCallFunc* t_call = CCCallFunc::create(this, callfunc_selector(Banana::randomPosition));
