...
//	else if(t_key == kSDS_GI_shopItem_int1_priceType_s)			rv = "si%dprcType";
	...
	else if(t_key == kSDS_GI_shopStartPack_title_s)				rv = "sspTitle";
	else if(t_key == kSDS_GI_shopStartPack_content_s)			rv = "sspContent";
	else if(t_key == kSDS_GI_shopStartPack_salePercent_s)		rv = "sspSalePercent";
	else if(t_key == kSDS_GI_shopStartPack_PriceOriginal_s)		rv = "sspPriceOriginal";
	else if(t_key == kSDS_GI_shopStartPack_PriceSale_s)			rv = "sspPriceSale";
	else if(t_key == kSDS_GI_shopStartPack_listCnt_i)			rv = "sspListCnt";
	else if(t_key == kSDS_GI_shopStartPack_int1_type_s)			rv = "ssp%dtype";
	else if(t_key == kSDS_GI_shopStartPack_int1_title_s)		rv = "ssp%dtitle";
	else if(t_key == kSDS_GI_shopStartPack_int1_viewNumber_i)	rv = "ssp%dviewNumber";
	...
	else if(t_key == kSDS_GI_shopEventPack_title_s)				rv = "sepTitle";
	else if(t_key == kSDS_GI_shopEventPack_content_s)			rv = "sepContent";
	else if(t_key == kSDS_GI_shopEventPack_salePercent_s)		rv = "sepSalePercent";
	else if(t_key == kSDS_GI_shopEventPack_PriceOriginal_s)		rv = "sepPriceOriginal";
	else if(t_key == kSDS_GI_shopEventPack_PriceSale_s)			rv = "sepPriceSale";
	else if(t_key == kSDS_GI_shopEventPack_listCnt_i)			rv = "sepListCnt";
	else if(t_key == kSDS_GI_shopEventPack_int1_type_s)			rv = "sep%dtype";
	else if(t_key == kSDS_GI_shopEventPack_int1_title_s)		rv = "sep%dtitle";
	else if(t_key == kSDS_GI_shopEventPack_int1_viewNumber_i)	rv = "sep%dviewNumber";
