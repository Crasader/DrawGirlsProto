...
void KSJuniorBase::checkConfine(float dt)
{
		 ...
		 dynamic_cast<KSJuniorBase*>(this)*/)
	{
		...
		myGD->createJackMissileWithStoneFunctor((StoneType)weapon_type, weapon_level, rmCnt, getPosition(), int(mySGD->getSelectedCharacterHistory().power.getV()*((rand()%21-10+100)/100.f)));
