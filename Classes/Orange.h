...
#ifndef __DGproto__Orange__
#define __DGproto__Orange__
...
class Orange : public KSCumberBase
{
public:
	Orange() :
...
//								   callfunc_selector(Orange::nullmEmotion));
...
#endif /* defined(__DGproto__Orange__) */
