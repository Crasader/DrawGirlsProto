...
//	ko->setObject(CCString::create("화면을 터치 해주세요."), kMyLocalKey_touchPlease);
	...
	ko->setObject(CCString::create("그전에 간단히 메뉴들을 소개해드릴께요."), kMyLocalKey_scenarioMent10);
	...
	ko->setObject(CCString::create("먼저 게임준비하러 가볼까요?"), kMyLocalKey_scenarioMent14);
	ko->setObject(CCString::create("이곳은 게임시작 전에 아이템구입이나\n미사일을 업그레이드 시킬 수 있는\n게임시작화면입니다."), kMyLocalKey_scenarioMent15);
	ko->setObject(CCString::create("게임을 시작하려면 하트가 필요합니다."), kMyLocalKey_scenarioMent16);
	ko->setObject(CCString::create("지금은 하트가 충분하니\n바로 시작하죠."), kMyLocalKey_scenarioMent17);
	...
	ko->setObject(CCString::create("이곳은 처음이실테니\n컨트롤 방법부터 설명드리겠습니다."), kMyLocalKey_scenarioMent20);
	...
	ko->setObject(CCString::create("그럼 계속 해볼까요?\n5스테이지 클리어후 메인화면에서 뵙기로 하죠!"), kMyLocalKey_scenarioMent30);
...
//	ko->setObject(CCString::create("젬이 부족하여 구매할 수 없습니다."), kMyLocalKey_notEnoughRuby);
//	
...
//	en->setObject(CCString::create("<font color=999 strokecolor=0 strokesize=1>%d승 %d패 </font><font color=950 strokecolor=0 strokesize=1>승률%d%%</font>"), kMyLocalKey_endlessInfoScoreValue);
	...
	en->setObject(CCString::create("그전에 간단히 메뉴들을 소개해드릴께요."), kMyLocalKey_scenarioMent10);
	...
	en->setObject(CCString::create("먼저 게임준비하러 가볼까요?"), kMyLocalKey_scenarioMent14);
	en->setObject(CCString::create("이곳은 게임시작 전에 아이템구입이나\n미사일을 업그레이드 시킬 수 있는\n게임시작화면입니다."), kMyLocalKey_scenarioMent15);
	...
	en->setObject(CCString::create("쉿. 일반 학생들이 다니는 교정안에서는\n닌자에관한 이야기는 하지 않는게 좋아.\n이곳의 닌자 양성 클래스는\n일반 학생들에겐 비밀이니까!"), kMyLocalKey_scenarioMent35);
	...
	en->setObject(CCString::create("히바리는 거치적 거리는 존재따위가 아니야.\n우리들은 모두 강하다고 인정받았으니까.\n히바리의 강한 점은 내가 제일 잘 알고있고,\n또 모두들 알고있어.\n그러니까 더 자신에게 자신감을 가져."), kMyLocalKey_scenarioMent43);
	en->setObject(CCString::create("야규.."), kMyLocalKey_scenarioMent44);
	en->setObject(CCString::create("내.. 내가 말하고 싶은건 그것뿐이야..\n히바리, 내일은 히바리가 좋아하는\n우사네 찻집에 가자."), kMyLocalKey_scenarioMent45);
	...
	en->setObject(CCString::create("으앙~ 마스크쓴 누나한테\n과자 뺏겼어!!"), kMyLocalKey_scenarioMent50);
	en->setObject(CCString::create("소매치기예요!!"), kMyLocalKey_scenarioMent51);
	en->setObject(CCString::create("아이의 즐거움을 잽싸게 뺏는\n배짱좋은 녀석이군.\n그런 썩은 자식은 우리들이 혼내줄테다!!"), kMyLocalKey_scenarioMent52);
	...
	en->setObject(CCString::create("이번엔 게임미션이 조금 다른것 같아요."), kMyLocalKey_kindTutorial13);
	en->setObject(CCString::create("네. 주어진 갯수만큼 생성되는 아이템을\n먹어야 클리어 됩니다.\n클리어하기 더 어려워지겠는데요?"), kMyLocalKey_kindTutorial14);
	en->setObject(CCString::create("게임시간이 엄청나게 줄어들었어요.\n조금 서둘러야겠는걸요."), kMyLocalKey_kindTutorial15);
	en->setObject(CCString::create("알고있어!! 게임중에 생기는 시간아이템을\n적절히 먹으면서 플레이하면 문제없을꺼야!!"), kMyLocalKey_kindTutorial16);
...
//	ja->setObject(CCString::create("基本チュートリアルが終わりました。\n5000ゴールドをプレゼントします。\n本ゲームに戻ります。"), kMyLocalKey_tutorial7);
  ...
  ja->setObject(CCString::create("Invisibility"), kMyLocalKey_warning1008);
	...
	ja->setObject(CCString::create("그전에 간단히 메뉴들을 소개해드릴께요."), kMyLocalKey_scenarioMent10);
	...
	ja->setObject(CCString::create("먼저 게임준비하러 가볼까요?"), kMyLocalKey_scenarioMent14);
	ja->setObject(CCString::create("이곳은 게임시작 전에 아이템구입이나\n미사일을 업그레이드 시킬 수 있는\n게임시작화면입니다."), kMyLocalKey_scenarioMent15);
	...
	ja->setObject(CCString::create("쉿. 일반 학생들이 다니는 교정안에서는\n닌자에관한 이야기는 하지 않는게 좋아.\n이곳의 닌자 양성 클래스는\n일반 학생들에겐 비밀이니까!"), kMyLocalKey_scenarioMent35);
	...
	ja->setObject(CCString::create("히바리는 거치적 거리는 존재따위가 아니야.\n우리들은 모두 강하다고 인정받았으니까.\n히바리의 강한 점은 내가 제일 잘 알고있고,\n또 모두들 알고있어.\n그러니까 더 자신에게 자신감을 가져."), kMyLocalKey_scenarioMent43);
	ja->setObject(CCString::create("야규.."), kMyLocalKey_scenarioMent44);
	ja->setObject(CCString::create("내.. 내가 말하고 싶은건 그것뿐이야..\n히바리, 내일은 히바리가 좋아하는\n우사네 찻집에 가자."), kMyLocalKey_scenarioMent45);
	...
	ja->setObject(CCString::create("으앙~ 마스크쓴 누나한테\n과자 뺏겼어!!"), kMyLocalKey_scenarioMent50);
	ja->setObject(CCString::create("소매치기예요!!"), kMyLocalKey_scenarioMent51);
	ja->setObject(CCString::create("아이의 즐거움을 잽싸게 뺏는\n배짱좋은 녀석이군.\n그런 썩은 자식은 우리들이 혼내줄테다!!"), kMyLocalKey_scenarioMent52);
	...
	ja->setObject(CCString::create("이번엔 게임미션이 조금 다른것 같아요."), kMyLocalKey_kindTutorial13);
	ja->setObject(CCString::create("네. 주어진 갯수만큼 생성되는 아이템을\n먹어야 클리어 됩니다.\n클리어하기 더 어려워지겠는데요?"), kMyLocalKey_kindTutorial14);
	ja->setObject(CCString::create("게임시간이 엄청나게 줄어들었어요.\n조금 서둘러야겠는걸요."), kMyLocalKey_kindTutorial15);
	ja->setObject(CCString::create("알고있어!! 게임중에 생기는 시간아이템을\n적절히 먹으면서 플레이하면 문제없을꺼야!!"), kMyLocalKey_kindTutorial16);
