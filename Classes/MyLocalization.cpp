...
void MyLocal::ko()
{
	...
	ko->setObject(CCString::create("<font newline=14 strokecolor=000 strokesize=0.5>스테이지를 클리어 할 때마다<font newline=30>클리어 단계에 따라 별을 획득합니다.<font color=961>한 스테이지<font newline=14>에서 획득할 수 있는<font color=961>별 갯수는 총 10개<font newline=14>입니다."), kMyLocalKey_detailConditionPopupContent);
...
//	ko->setObject(CCString::create("입니다."), kMyLocalKey_detailConditionPopupContent5);
	...
	ko->setObject(CCString::create("<font strokesize=0.5>누적영역</font><font color=961 strokesize=0.5>%d%%</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalPercent1);
	...
	ko->setObject(CCString::create("<font strokesize=0.5>누적점수</font><font color=961 strokesize=0.5>%d%점</font><font strokesize=0.5>을 획득하라</font>"), kMyLocalKey_todaymissionTotalScore1);
	...
	ko->setObject(CCString::create("<font color=961 strokesize=0.5>%d골드</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalTakeGold1);
	...
	ko->setObject(CCString::create("<font strokesize=0.5>부하몹</font><font color=961 strokesize=0.5>%d마리</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalCatch1);
	...
	ko->setObject(CCString::create("<font newline=16 strokesize=0.5>오늘의 미션을 완료하였습니다.<font color=961 newline=16 strokesize=0.5>보상은 선물함으로 지급됩니다."), kMyLocalKey_todaymissionSuccessCommon);
...
//	ko->setObject(CCString::create("화면을 터치 해주세요."), kMyLocalKey_touchPlease);
	...
	ko->setObject(CCString::create("<font color=961 strokesize=0.5>연속으로 출석<font newline=15 strokesize=0.5>해야 선물을 받으실 수 있어요!<font color=961 strokesize=0.5>출석 선물은 선물함에서 확인<font newline=13 strokesize=0.5>하세요!"), kMyLocalKey_attendanceContent);
...
//	en->setObject(CCString::create("입니다."), kMyLocalKey_detailConditionPopupContent5);
	...
	en->setObject(CCString::create("<font strokesize=0.5>누적영역</font><font color=961 strokesize=0.5>%d%%</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalPercent1);
	...
	en->setObject(CCString::create("<font strokesize=0.5>누적점수</font><font color=961 strokesize=0.5>%d%점</font><font strokesize=0.5>을 획득하라</font>"), kMyLocalKey_todaymissionTotalScore1);
	...
	en->setObject(CCString::create("<font color=961 strokesize=0.5>%d골드</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalTakeGold1);
	...
	en->setObject(CCString::create("<font strokesize=0.5>부하몹</font><font color=961 strokesize=0.5>%d마리</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalCatch1);
...
//	ja->setObject(CCString::create("입니다."), kMyLocalKey_detailConditionPopupContent5);
	...
	ja->setObject(CCString::create("<font strokesize=0.5>누적영역</font><font color=961 strokesize=0.5>%d%%</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalPercent1);
	...
	ja->setObject(CCString::create("<font strokesize=0.5>누적점수</font><font color=961 strokesize=0.5>%d%점</font><font strokesize=0.5>을 획득하라</font>"), kMyLocalKey_todaymissionTotalScore1);
	...
	ja->setObject(CCString::create("<font color=961 strokesize=0.5>%d골드</font><font strokesize=0.5>를 획득하라</font>"), kMyLocalKey_todaymissionTotalTakeGold1);
	...
	ja->setObject(CCString::create("<font strokesize=0.5>부하몹</font><font color=961 strokesize=0.5>%d마리</font><font strokesize=0.5>를 사냥하라</font>"), kMyLocalKey_todaymissionTotalCatch1);
	...
	ja->setObject(CCString::create("<font color=999 size=13 strokesize=0.5>남은시간"), kMyLocalKey_todaymissionRemainTime);
