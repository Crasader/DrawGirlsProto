...
//		   t_code == kAchievementCode_ruby1 || t_code == kAchievementCode_ruby2 || t_code == kAchievementCode_ruby3 ||
//		   t_code == kAchievementCode_social1 || t_code == kAchievementCode_social2 || t_code == kAchievementCode_social3 ||
//		   t_code == kAchievementCode_luckySeven1 || t_code == kAchievementCode_luckySeven2 || t_code == kAchievementCode_luckySeven3 ||
//		   t_code == kAchievementCode_feverMania1 ||
//		   t_code == kAchievementCode_comboMania1 || t_code == kAchievementCode_comboMania2 || t_code == kAchievementCode_comboMania3 ||
//		   t_code == kAchievementCode_attacker1 || t_code == kAchievementCode_attacker2 || t_code == kAchievementCode_attacker3 ||
//		   t_code == kAchievementCode_dieHard1 || t_code == kAchievementCode_dieHard2 || t_code == kAchievementCode_dieHard3 ||
//		   t_code == kAchievementCode_scoreHigh1 || t_code == kAchievementCode_scoreHigh2 || t_code == kAchievementCode_scoreHigh3 ||
//		   t_code == kAchievementCode_allPiece1 || t_code == kAchievementCode_allPiece2 || t_code == kAchievementCode_allPiece3 ||
//		   t_code == kAchievementCode_fastClear1 || t_code == kAchievementCode_fastClear2 || t_code == kAchievementCode_fastClear3 ||
//		   t_code == kAchievementCode_cardCollection1 || t_code == kAchievementCode_cardCollection2 || t_code == kAchievementCode_cardCollection3 ||
//		   t_code == kAchievementCode_friend1 || t_code == kAchievementCode_friend2 || t_code == kAchievementCode_friend3 ||
//		   t_code == kAchievementCode_gachaKing || t_code == kAchievementCode_puzzleKing || t_code == kAchievementCode_characterCollection ||
//		   t_code == kAchievementCode_goldMania || t_code == kAchievementCode_tutorial || t_code == kAchievementCode_cardSet ||
//		   t_code == kAchievementCode_reviewer || t_code == kAchievementCode_hidden_returnee || t_code == kAchievementCode_hidden_bigHand1 ||
//		   t_code == kAchievementCode_hidden_bigHand2 || t_code == kAchievementCode_hidden_holder || t_code == kAchievementCode_hidden_noSound ||
//		   t_code == kAchievementCode_hidden_breathtaking1 || t_code == kAchievementCode_hidden_breathtaking2 ||
//		   t_code == kAchievementCode_hidden_dieEasy || t_code == kAchievementCode_hidden_speedMania)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieveData_int1_value, t_code) == 1;	}
//		else if(t_code == kAchievementCode_heart1 || t_code == kAchievementCode_heart2 || t_code == kAchievementCode_heart3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_sendHeartCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_bonusGame1 || t_code == kAchievementCode_bonusGame2 || t_code == kAchievementCode_bonusGame3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_playBonusGameCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_mapGacha1 || t_code == kAchievementCode_mapGacha2 || t_code == kAchievementCode_mapGacha3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_mapGachaCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_feverMania2 || kAchievementCode_feverMania3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_totalFeverCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_noFail1 || t_code == kAchievementCode_noFail2 || t_code == kAchievementCode_noFail3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_seqNoFailCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_hunter1 || t_code == kAchievementCode_hunter2 || t_code == kAchievementCode_hunter3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_catchMonsterCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_continue1 || t_code == kAchievementCode_continue2 || t_code == kAchievementCode_continue3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_continueCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_attendance1 || t_code == kAchievementCode_attendance2 || t_code == kAchievementCode_attendance3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_attendanceCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_changeMania1 || t_code == kAchievementCode_changeMania2 || t_code == kAchievementCode_changeMania3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_changeCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_fail1 || t_code == kAchievementCode_fail2 || t_code == kAchievementCode_fail3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_failCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_invite1 || t_code == kAchievementCode_invite2 || t_code == kAchievementCode_invite3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_inviteCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_challenger1 || t_code == kAchievementCode_challenger2 || t_code == kAchievementCode_challenger3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_challengeCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_help1 || t_code == kAchievementCode_help2 || t_code == kAchievementCode_help3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_helpCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_helper1 || t_code == kAchievementCode_helper2 || t_code == kAchievementCode_helper3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_helpAcceptCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_defender1 || t_code == kAchievementCode_defender2 || t_code == kAchievementCode_defender3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_challengeAcceptCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_upgrade1 || t_code == kAchievementCode_upgrade2 || t_code == kAchievementCode_upgrade3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_upgradeSuccessCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_perfect1 || t_code == kAchievementCode_perfect2 || t_code == kAchievementCode_perfect3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_perfectClearCnt) >= getCondition(t_code);	}
...
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_seqAttendanceCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_gacha1)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_gacha1Cnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_gacha2)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_gacha2Cnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_gacha3)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_gacha3Cnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_gacha4)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_gacha4Cnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_weeklyKing)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_weeklyTopCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_luckyGuy)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_startLuckyCnt) >= getCondition(t_code);	}
//		
//		else if(t_code == kAchievementCode_hidden_shopper1) // (히든)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_enterShopCnt) >= getCondition(t_code);	}
//		else if(t_code == kAchievementCode_hidden_shopper2 || t_code == kAchievementCode_hidden_shopper3) // (히든)
//		{	return_value = myDSH->getIntegerForKey(kDSH_Key_achieve_itemBuyCnt) >= getCondition(t_code);	}
