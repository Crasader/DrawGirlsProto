...
void DiaryZoom::startStageAnimation()
{
...
void DiaryZoom::ccTouchesBegan( CCSet *pTouches, CCEvent *pEvent )
{
	CCSetIterator iter;
	CCTouch *touch;
...
void DiaryZoom::ccTouchesMoved( CCSet *pTouches, CCEvent *pEvent )
{
	CCSetIterator iter;
	CCTouch* touch;
...
void DiaryZoom::ccTouchesEnded( CCSet *pTouches, CCEvent *pEvent )
{
	CCSetIterator iter;
	CCTouch* touch;
...
void DiaryZoom::ccTouchesCancelled( CCSet *pTouches, CCEvent *pEvent )
{
