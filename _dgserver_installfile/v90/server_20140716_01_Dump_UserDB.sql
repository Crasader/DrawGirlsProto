...
-- CHANGE MASTER TO MASTER_LOG_FILE='mysql-bin.000179', MASTER_LOG_POS=107;
...
CREATE TABLE `UserLogTable` (
  ...
  PRIMARY KEY (`no`),
  KEY `memberID` (`memberID`)
) ENGINE=InnoDB AUTO_INCREMENT=434357 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UserPropertyHistory` (
  ...
  PRIMARY KEY (`no`),
  KEY `memberID` (`memberID`)
) ENGINE=InnoDB AUTO_INCREMENT=7924 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-07-16  7:06:31
