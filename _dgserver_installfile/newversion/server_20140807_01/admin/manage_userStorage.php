...
<table class="LQDataTable" dbSource="dataManager2.php"  dbClass="UserStorage" autoLoad="false" autoSetting="true" dbWhere='{}' dbLimit="10" dbSort='{"no":"desc"}' name="datatable" border=1 commenter='{"type":"custom","func":"commenter"}'>
	<thead>
	</thead>
	<tbody datazone>
