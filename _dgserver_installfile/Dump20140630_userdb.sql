...
-- CHANGE MASTER TO MASTER_LOG_FILE='mysql-bin.000168', MASTER_LOG_POS=107;
...
CREATE TABLE `UserLogTable` (
  ...
  PRIMARY KEY (`no`),
  KEY `memberID` (`memberID`)
) ENGINE=InnoDB AUTO_INCREMENT=411297 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-06-30 10:58:02
